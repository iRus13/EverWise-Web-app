...
- All 5 exams: answer all 10 questions correctly and verify the exact passing score, then separately fail with one correct answer. Answer buttons lock after selection. Failure cannot expose the completion action. Retake starts at question one with no selected answer; answering all questions incorrectly on that second attempt produces zero, proving the earlier nonzero score was cleared. Back exits cleanly.
